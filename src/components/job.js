...
import {FormattedDate, FormattedPlural, FormattedRelative,FormattedNumber} from 'react-intl';
  	...
  	render() {
  		return (
  			<tr>
      			...
      			<td>{this.props.offer.salary} <FormattedPlural value={this.props.offer.salary}
				  one='million'
				  other='millions'/></td>
